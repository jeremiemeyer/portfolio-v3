    ...
    <footer>
      <div className="mx-auto p-6 md:py-8">
        <div className="flex flex-row items-center justify-between gap-2">
          ...
          <ul className="flex text-zinc-500 dark:text-zinc-400 sm:mb-0 gap-2 md:gap-6">
        ...
        <span className="flex flex-col my-6 text-sm text-zinc-500 dark:text-zinc-400 text-center">
          <span>
